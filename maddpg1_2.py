...
def modify_obs(observations, agent_name):
    ...
    obs = [rel_pos_to_goal[0], rel_pos_to_goal[1], 0, heading_error[0], heading_error[1], speed, steering, distance_bet_agents[0], distance_bet_agents[1], 0]
...
if __name__ == '__main__':
    ...
    np.save('maddpg_scores.npy', np.array(eval_scores))
