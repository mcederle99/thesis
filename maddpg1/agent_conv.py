...
class Agent:
    def __init__(self, actor_dims, critic_dims, n_actions,
                ...
                max_action, alpha=1e-4, beta=1e-3, gamma=0.95, tau=0.01):
        self.gamma = gamma
        self.tau = tau
        ...
        self.target_actor = ActorNetwork(alpha, actor_dims,
    ...
    def learn(self, memory, agent_list):
        ...
        states_ = T.tensor(states_, dtype=T.float, device=device)
        dones = T.tensor(dones, device=device)
