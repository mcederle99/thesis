...
gen_scenario(
    scenario=Scenario(
        traffic=None,
        ego_missions=[
            Mission(Route(begin=("edge-east-EW", 0, 10), end=("edge-south-NS", 0, 30))),
            Mission(Route(begin=("edge-south-SN", 0, 10), end=("edge-west-EW", 0, 30))),
            Mission(Route(begin=("edge-west-WE", 0, 10), end=("edge-east-WE", 0, 30))),
...
#            ),
            f"s-agent-{social_agent1.name}": (
                [social_agent1],
                [
                    EndlessMission(begin=("edge-south-SN", 0, 20), start_time=0),
                ],
            ),
