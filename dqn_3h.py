...
if __name__ == '__main__':
    ...
    headless = False
    env = make_env("smarts.env:hiway-v0", agent_specs, 'scenarios/sumo/3agents_hd', headless)
    
    agent_007 = DuelingDQNAgent(gamma=0.99, epsilon=1.0, lr=0.0001, input_dims=(env.observation_space.shape), n_actions=4, mem_size=20000, eps_min=0.01, batch_size=32, replace=1000, eps_dec=1e-5, chkpt_dir='results/dqn', algo='DuelingDQNAgent', env_name='3agents_hd')

    agent_008 = DuelingDQNAgent(gamma=0.99, epsilon=1.0, lr=0.0001, input_dims=(env.observation_space.shape), n_actions=4, mem_size=20000, eps_min=0.01, batch_size=32, replace=1000, eps_dec=1e-5, chkpt_dir='results/dqn', algo='DuelingDQNAgent', env_name='3agents_hd')
    
    agent_009 = DuelingDQNAgent(gamma=0.99, epsilon=1.0, lr=0.0001, input_dims=(env.observation_space.shape), n_actions=4, mem_size=20000, eps_min=0.01, batch_size=32, replace=1000, eps_dec=1e-5, chkpt_dir='results/dqn', algo='DuelingDQNAgent', env_name='3agents_hd')
