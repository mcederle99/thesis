...
social_agent4 = SocialAgentActor(
    name="zoo-car4",
    agent_locator="scenarios.sumo.zoo_intersection.agent_prefabs:zoo-agent2-v0",
    initial_speed=12,
)
...
gen_scenario(
    scenario=Scenario(
        traffic=None,
        ego_missions=[
            Mission(Route(begin=("edge-east-EW", 0, 15), end=("edge-south-NS", 0, 30))),
            Mission(Route(begin=("edge-east-EW", 0, 30), end=("edge-west-EW", 0, 60))),
            Mission(Route(begin=("edge-south-SN", 0, 15), end=("edge-west-EW", 0, 30))),
            Mission(Route(begin=("edge-west-WE", 0, 15), end=("edge-east-WE", 0, 30))),
            Mission(Route(begin=("edge-south-SN", 0, 30), end=("edge-east-WE", 0, 60))),
            Mission(Route(begin=("edge-west-WE", 0, 30), end=("edge-south-NS", 0, 60))),
#            Mission(Route(begin=("edge-south-SN", 0, 15), end=("edge-west-EW", 0, 30))),
        ],
...
#                    Mission(
#                        Route(
#                            begin=("edge-south-SN", 0, 15), end=("edge-west-EW", 0, 30)
#                        ),
#                    ),
#                ],
#            ),
...
#                [social_agent1],
#                [
#                    EndlessMission(begin=("edge-south-SN", 0, 10), start_time=0),
#                ],
#            ),
#            f"s-agent-{social_agent3.name}": (
#                [social_agent3],
#                [
#                    EndlessMission(begin=("edge-west-WE", 0, 15), start_time=0),
#                ],
#            ),
#            f"s-agent-{social_agent4.name}": (
#                [social_agent4],
#                [
#                    EndlessMission(begin=("edge-east-EW", 0, 15), start_time=0),
#                ],
#            ),
#        },
    ),
