...
if __name__ == '__main__':
    ...
    agent_007 = DuelingDQNAgent(gamma=0.99, epsilon=0.0, lr=0.0001, input_dims=(env.observation_space.shape), n_actions=4, mem_size=20000, eps_min=0.00, batch_size=32, replace=1000, eps_dec=1e-5, chkpt_dir='results/dqn', algo='DuelingDQNAgent', env_name='2agents_nohd')

    agent_008 = DuelingDQNAgent(gamma=0.99, epsilon=0.0, lr=0.0001, input_dims=(env.observation_space.shape), n_actions=4, mem_size=20000, eps_min=0.00, batch_size=32, replace=1000, eps_dec=1e-5, chkpt_dir='results/dqn', algo='DuelingDQNAgent', env_name='2agents_nohd')
