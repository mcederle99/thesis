import torch as T
import numpy as np
from maddpg.networks_conv import ActorNetwork, CriticNetwork

class Agent:
    def __init__(self, actor_dims, critic_dims, n_actions, agent_idx, chkpt_dir,
            alpha=0.01, beta=0.01, fc2=64, gamma=0.95, tau=0.01, n_agents=2):
        self.gamma = gamma
        self.tau = tau
        ...
        self.critic = CriticNetwork(beta, critic_dims, n_agents,
        ...
        self.target_critic = CriticNetwork(beta, critic_dims, n_agents,
